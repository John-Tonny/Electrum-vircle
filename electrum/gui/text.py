...
from electrum.bitcoin import is_address, COIN, TYPE_ADDRESS, OUTPUT_STANDARD
...
class ElectrumGui:
    ...
    def do_send(self):
        ...
        if self.wallet.has_password():
            ...
            password = None
        try:
            tx = self.wallet.mktx([TxOutput(TYPE_ADDRESS, self.str_recipient, amount, OUTPUT_STANDARD)],
